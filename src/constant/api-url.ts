...
export const API_URL = {
  ...
  EVENTS: {
    ...
    GET_EVENT_CREATIONS_HISTORY: `${EVENT}/get-event-creations-history`,
    EVENT_OPEN_STATE: `${EVENT}/event-open-state`,
    EVENTS_IN_DATE_FOR_CHECKIN: `${EVENT}/events-in-date-for-checkin`,
    STATISTICS: `${EVENT}/statistic/total`,
    EVENT_DATES_IN_MONTH: `${EVENT}/event-dates-in-month`,
    EVENTS_IN_DATE: `${EVENT}/events-in-date`,
    GET_ALL_EVENT_CREATE_REQUESTS: `${EVENT}/get-all-event-create-requests`,
  },
  IMAGES: {
    INDEX: `${IMAGE}`,
    LIST: `${IMAGE}/list`,
